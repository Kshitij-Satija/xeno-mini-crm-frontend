...
const RuleBlock = ({ index, rule, onChange, onRemove }) => (
  <div className="flex gap-3 mb-3 items-center border rounded-lg p-3 bg-white shadow-sm hover:shadow-md transition">

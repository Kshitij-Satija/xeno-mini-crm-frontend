  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4 sm:p-8">
      <div className="max-w-6xl w-full space-y-16">
        ...
        {/* GitHub Modal */}
        {isModalOpen && (
          <div className="fixed inset-0 min-h-dvh flex items-center justify-center bg-black/10  z-50">
            <div className="bg-white rounded-2xl p-8 shadow-2xl w-80 text-center">
              ...
              <div className="space-y-4">
                <button
                  onClick={() =>
                    openRepo("https://github.com/Kshitij-Satija/xeno-mini-crm-frontend")
                  }
                ...
                <button
                  onClick={() =>
                    openRepo("https://github.com/Kshitij-Satija/xeno-mini-crm-backend")
                  }
